...
Planned (is this possible?)
* jump to definition
* fast syntax check (maybe on buf write?)
* use stdin/out for communication instead of TCP/IP and start daemon
  automatically
* think about when ( should be appended
* camelCase completion ? gC -> getClass
* create views for class hirarchies and relations ?
...
|Ctrl+s Ctrl+t | command mode | Print type information of expression under cursor |
